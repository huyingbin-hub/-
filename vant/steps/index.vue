...
<view :class="'custom-class ' + utils.bem('steps', [direction])">
  <view class="van-step__wrapper">
    <view v-for="(item, index) in steps" :key="index" @tap="onClick" :data-index="index" :class="utils.bem('step', [direction, status(index, active)]) + ' van-hairline'" :style="status(index, active) === 'inactive' ? 'color: ' + inactiveColor: ''">
