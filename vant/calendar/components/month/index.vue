...
<view class="van-calendar__month" :style="computed.getMonthStyle(visible, date, rowHeight)">
  ...
  <view v-if="visible" class="van-calendar__days">
    ...
    <view v-for="(item, index) in days" :key="index" :style="computed.getDayStyle(item.type, index, date, rowHeight, color)" :class="utils.bem('calendar__day', [item.type]) + ' ' + item.className" :data-index="index" @tap="onClick">
