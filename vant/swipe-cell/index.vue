<template>
<view class="van-swipe-cell" data-key="cell" @tap.stop="onClick" @touchstart="startDrag" :catchtouchmove="catchMove ? 'noop' : ''" capture-bind:touchmove="onDrag" @touchend="endDrag" @touchcancel="endDrag">
